 ...
 */
package com.chadekin.jadys.syntax.orderby.generic.impl;
 ...
 */
public class OrderByClauseBuilderImpl<P> extends AbstractOrderByClauseBuilder<OrderByClauseBuilder<P>> implements OrderByClauseBuilder<OrderByClauseBuilder<P>> {
