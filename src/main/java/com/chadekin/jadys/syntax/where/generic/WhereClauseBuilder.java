...
/**
 * WhereClauseBuilder
 * @param <W> Where clause, per sql dialect
 * @param <O> OrderBy clause, per sql dialect
 */
public interface WhereClauseBuilder<W, O> extends WhereStatement<W>, GroupByStatement<O>, HavingStatement<O>, OrderByStatement<O> {
