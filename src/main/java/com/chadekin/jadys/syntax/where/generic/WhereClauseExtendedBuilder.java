 ...
 */
package com.chadekin.jadys.syntax.where.generic;
 ...
 * @param <PG> Post GroupBy Statement    
 * @param <PH> Post Having Statement    
 * @param <O> OrderBy clause per sql dialect     
 */
public interface WhereClauseExtendedBuilder<X, PG, PH, O> extends JunctionOperator<X>, ParameterOperator<X>, GroupByStatement<PG>, HavingStatement<PH>, OrderByStatement<O> {
