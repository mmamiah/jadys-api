 ...
 */
package com.chadekin.jadys.syntax.having.generic;
...
/**
 * HavingExtendedBuilder
 */
public interface HavingExtendedBuilder<T extends JadysSqlQueryBuilder> extends JunctionOperator<T>, SqlFunctionProxy<T>, OrderByStatement<T> {
