...
/**
 * Test for String formatter
 */
public class StringValueFormatterTest {

	private StringValueFormatter formatter;
	
	@Before
	public void init(){
		formatter = new StringValueFormatter();
	}
	...
	@Test
	public void shouldFormatWhenAnotherType(){
		// Arrange
	...
	@Test
	public void shouldFormatJadysNull(){
		// Arrange
		Object value = JadysKeys.UNDERLINE;
