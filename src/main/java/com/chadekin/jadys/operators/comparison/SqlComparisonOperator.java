 ...
 */
package com.chadekin.jadys.operators.comparison;
...
import com.chadekin.jadys.validation.SqlInjectionPredicate;

/**
 * SqlComparisonOperator
 */
public interface SqlComparisonOperator<T> extends SqlOperator {

	public default void executeOperation(JadysSqlOperation jadysSqlOperation, Object value){
		...
		if(this instanceof SqlExpressionHandler){
			...
			handler.addArgument(jadysSqlOperation);
